...
export const counts = [
  {
    ...
    icon: (
      <LocalFireDepartmentRounded sx={{ color: "inherit", fontSize: "35px" }} />
    ),
  ...
  {
    name: "Workouts",
    icon: <FitnessCenterRounded sx={{ color: "inherit", fontSize: "35px" }} />,
  ...
  },
  {
    ...
    icon: <TimelineRounded sx={{ color: "inherit", fontSize: "35px" }} />,
